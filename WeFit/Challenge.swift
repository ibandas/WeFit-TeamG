        ...
        ref.getDocuments(completion: {(snapshot, error) in
            if error != nil {
                ...
                for document in snap.documents {
                    ...
                    let challenge = Challenge(title: title!, exercise: exercise!, mectric: mectric!, group_owner: group_owner!, group_members: members!, leaderboard: competitors, created_at: created_at, ends_at: ends_at)
